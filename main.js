...
mobile: MethodMobile, 
browser: opcion == '1' ? ['RagnaBot', 'Edge', '2.0.0'] : methodCodeQR ? ['RagnaBot', 'Edge', '2.0.0'] : ['Ubuntu', 'Chrome', '110.0.1587.56'],
auth: {
creds: state.creds,
...
let prekey = []
let directorio = readdirSync("./RagnaSession")
let filesFolderPreKeys = directorio.filter(file => {
return file.startsWith('pre-key-')
})
prekey = [...prekey, ...filesFolderPreKeys]
filesFolderPreKeys.forEach(files => {
unlinkSync(`./RagnaSession/${files}`)
})
} 
...
const directories = ['./RagnaSession/', './GataJadiBot/']
