...
try {
let syms = `Actuaras como un Bot de WhatsApp el cual fue creado por Ragna, tu seras RagnaBot`
...
case isCommand5:
if (!text) return m.reply(lenguajeGB.smsMalused2() + `*${usedPrefix + command}* RagnaBot`)
try{
