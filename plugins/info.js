...
correo = official[0][0] == String(contact[0]) ? 'ragnabot27@gamil.com' : official[1][0] == String(contact[0]) ? 'ragnabot27@gmail.com' : official[2][0] == String(contact[0]) ? 'ragnabot27@gmail.com' : mail === '' ? lenguajeGB.smsContacto6() : mail
...
enlace = official[0][0] == String(contact[0]) ? 'https://github.com/RAGNA01-B' : official[1][0] == String(contact[0]) ? 'https://github.com/RAGNA01-B' : official[2][0] == String(contact[0]) ? 'https://github.com/RAGNA01-B' : official[3][0] == String(contact[0]) ? 'https://github.com/RAGNA01-B' : md    
lista.push([number, ofc, nombre, description, official[3][0] == String(contact[0]) ? null : correo, lugar, enlace, bio, official[1][0] == String(contact[0]) ? 'https://www.youtube.com/@ragnabot-0' : null]) }  
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), packname, lenguajeGB.smsContacto8(), mail === '' ? 'ragnabot27@gmail.com' : mail, lenguajeGB.smsContacto7(), md, bioBot, yt, ig, fb, paypal, nna])
...
await conn.sendMessage('120363348505569664@newsletter', { text: m.quoted ? teks2 + m.quoted.text : teks2, contextInfo: {
externalAdReply: {
